...
and nt_quoted exp =
  ...
  (make_paired (star (caten (word "#;") all_exps)) (star (caten (word "#;") all_exps)) (make_spaced_and_commented nt_quoted)) exp;
  ...
  let nt_tagged_exp =
    ...
    let nt_2 = pack (caten nt_tagged_exp (disj_list [nt_all_not_paranthesized; nt_improper_list]))
        (fun (ref_name_as_list, rest_of_exp) ->
           ...
           TaggedSexpr(name, list_of_pairs)) in
    disj nt_1 nt_2 in
  (make_paired (star (caten (word "#;") all_exps)) (star (caten (word "#;") all_exps)) (make_spaced_and_commented (disj nt_tagged_exp nt_tag_ref_exp))) exp;
...
and nt_number exp =
  ...
  (make_paired (star (caten (word "#;") all_exps)) (star (caten (word "#;") all_exps)) nt) exp;
...
and nt_string exp =
  ...
  (make_paired (star (caten (word "#;") all_exps)) (star (caten (word "#;") all_exps)) (make_spaced_and_commented string_tok)) exp;
...
and symbol_parser exp =
  ...
  (make_paired (star (caten (word "#;") all_exps)) (star (caten (word "#;") all_exps)) (make_spaced_and_commented (not_followed_by sym_parse (char '@')))) exp;
...
and boolean_parser exp =
  ...
  (make_paired (star (caten (word "#;") all_exps)) (star (caten (word "#;") all_exps)) (make_spaced_and_commented last_nt)) exp;
...
and char_parser exp =
  ...
  (make_paired (star (caten (word "#;") all_exps)) (star (caten (word "#;") all_exps)) (make_spaced_and_commented char_nt2)) exp;;
...
= struct
  ...
  (* TODO why plus? and also why not throw exceptino if no match? *)
